  ...
  describe 'private methods' do
    describe 'NSQ commands' do
      describe '#identify' do
        ...
        CLIENTID = Socket.gethostbyname(HOSTNAME).flatten.compact.first
        it 'generates a correct id' do
          expect(@connection).to receive(:write_to_socket).with(
            %Q{IDENTIFY\n\x00\x00\x01.{\"client_id\":\"#{CLIENTID}\",\"hostname\":\"#{HOSTNAME}\",\"feature_negotiation\":false,\"heartbeat_interval\":30000,\"output_buffer\":16000,\"output_buffer_timeout\":250,\"tls_v1\":false,\"snappy\":false,\"deflate\":false,\"sample_rate\":0,\"user_agent\":\"nsq-ruby-client/0.0.1\",\"msg_timeout\":60000}}
          )
